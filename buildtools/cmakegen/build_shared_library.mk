...
LOCAL_MODULE := $(LOCAL_MODULE_LIBNAME)_shared

$(shell echo add_library\($(LOCAL_MODULE) SHARED $(LOCAL_SRC_FILES)\) >> $(CMAKELISTSTXT))
$(shell echo set_target_properties\($(LOCAL_MODULE) PROPERTIES OUTPUT_NAME $(LOCAL_MODULE_LIBNAME)\) >> $(CMAKELISTSTXT))
